...
Vector2iVector, Vector3dVector = o3d.utility.Vector2iVector, o3d.utility.Vector3dVector
...
def show_mixed_pcd_with_inserted_labels(pcd_road, pcd_non_road, pc_objs, initial_boxes, meshes, temp_boxes):
    ...
    for i in meshes:
        ...
        box3d, angle = UtilsBox.change_box3d(box3d)
...
def get_coners_from_label_arr(label_arr, calib_path):
    obj_list = [object3d_kitti.Object3d(label=label) for label in label_arr]
